...
def See_All():
	...
	see_all_table.heading('type', text='Type', command=lambda: Sort_Column(see_all_table, 'type', False))
	see_all_table.column('type', anchor='center', width=50)
	see_all_table.heading('priority', text='Priority', command=lambda: Sort_Column(see_all_table, 'priority', False))
...
def Search_Ticket(title):
	...
	ticket_details.geometry("300x400")
	...
	ID_box = Entry(ticket_details, width=30)
	ID_box.grid(row=1, column=0, columnspan=2, padx=5)
	...
	title_box.grid(row=3, column=0, columnspan=2, padx=5)
	...
	description_box = Entry(ticket_details, width=30)
	description_box.grid(row=5, column=0, columnspan=2, padx=5)
	...
	project_box.grid(row=7, column=0, columnspan=2, padx=5)
	...
	type_box = Entry(ticket_details, width=30)
	type_box.grid(row=9, column=0, columnspan=2, padx=5)
	...
	priority_box = Entry(ticket_details, width=30)
	priority_box.grid(row=11, column=0, columnspan=2, padx=5)
	...
	date_box = Entry(ticket_details, width=30)
	date_box.grid(row=13, column=0, columnspan=2, padx=5)
	...
	close_btn.grid(row=14, column=1, padx=10, pady=10)
